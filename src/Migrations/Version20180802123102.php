 ...
 */
final class Version20180802123102 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE forum (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, is_news_forum TINYINT(1) DEFAULT NULL, is_root_forum TINYINT(1) DEFAULT NULL, INDEX IDX_852BBECD727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE app_users (id INT AUTO_INCREMENT NOT NULL, login VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, user_role VARCHAR(255) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, subtitle VARCHAR(255) DEFAULT NULL, signature VARCHAR(255) DEFAULT NULL, localisation VARCHAR(255) DEFAULT NULL, moderation_status INT NOT NULL, date_inscription DATETIME NOT NULL, newsletter_subscriber TINYINT(1) NOT NULL, date_subscription DATETIME DEFAULT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
